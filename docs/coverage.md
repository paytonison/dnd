...
| 5.5E (2024) / SRD 5.2.1 | Implemented experimental fighter and wizard levels 1–3, origins, equipment and spell choices | Official CC BY source; complete class/species/background acceptance passes; see `sources-srd55.md` |
| 5.5E (2024) / SRD 5.2.1 expanded module 2.0.0 | All 12 classes/subclasses through 20, full spell catalog, ordered class gains, feat/feature capacities and current effects | Complete public fixtures for all 240 single-class states pass; physical Wizard book lifecycle has focused and native acceptance; full lifecycle still in progress, see `v2-progress.md` |
...
| 5E (2014) / SRD 5.1, module 1.0.0 | Experimental partial slice: Human Fighter 1-3, Champion, Acolyte, ability generation, six Fighting Styles, starting gear/loadouts, advancement and resource/rest actions | Original-source tables and supplementary 2014-rule corrections inspected; independent expectations in [sources-srd51.md](sources-srd51.md). Current automated/native/export/package evidence is separate in [the September 11 checkpoint](5e-validation-20260911.md). Full SRD 5.1 coverage is not claimed. |
...
On September 11, 2026, the user prioritized original 2014 **5E** as a separate edition and named the revised 2024 rules **5.5E**. The initial `srd51-core@1.0.0` pack contains 98 records: 1 creation table, 1 race, 1 class, 1 subclass, 1 background, 6 Fighting Styles, 8 languages, 18 skills, 12 armor suits, 1 shield, 35 weapons, and 13 gear records. This inventory describes the implemented slice, not all legal 5E characters. Fighter's supported level 3 is a coverage cutoff; the original class continues to 20. Other races/classes/backgrounds, levels 4-20, feats, spellcasting, multiclassing, Lance/Net, general inventory lifecycle, and supplements remain unimplemented. [The 5E guide](srd51.md) records the supported workflows and limitations.
