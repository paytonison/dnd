...
1. **Beyond level 14:** X8 says some human classes can continue and offers suggested extrapolations, explicitly reserving more detail for a future Companion publication. This release implements the complete X5/X6 tables, not speculative spell slots, saves, or class abilities through 36. The module's displayed maximum is its verified coverage limit for those human classes.
